...
public class Card implements ija.ija2016.homework2.model.cards.Card{
    ...
    public String toString() {
        switch (value) {
            case 1: return "A(" + card_color.toString() + ")";
            case 2:
            case 3:
            case 4:
            case 5:
            ...
            case 8:
            case 9:
            case 10: return "" + value + "(" + card_color.toString() + ")";
            case 11: return "J(" + card_color.toString() + ")";
            case 12: return "Q(" + card_color.toString() + ")";
            case 13: return "K(" + card_color.toString() + ")";
    ...
    public boolean turnFaceUp() {
        ...
        return (!card_state && (this.card_state = true));
    }
