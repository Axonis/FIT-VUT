...
\projectinfo{
  ...
  title.cs={Monitorovanie siete},  % název práce v češtině či slovenštině (dle zadání) / thesis title in czech language (according to assignment)
  title.en={Network monitoring}, % název práce v angličtině / thesis title in english
