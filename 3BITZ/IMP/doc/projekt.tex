...
\projectinfo{
  ...
  title.cs={Zabezpečenie dát pomocou 16/32-bit. kódu CRC},  %nazev prace v cestine ci slovenstine (dle zadani) / thesis title in czech language (according to assignment)
  title.en={Securing data with 16/32-bit CRC code}, %nazev prace v anglictine / thesis title in english
  %Autor / Author
  author={Jozef Urbanovský},   %cele jmeno a prijmeni autora / full name and surname of the author
  author.name={Jozef},   %jmeno autora (pro citaci) / author name (for reference) 
  author.surname={Urbanovský},   %prijmeni autora (pro citaci) / author surname (for reference) 
